export const rangeTable = Object.freeze({
  1: 33,
  2: 28,
  3: 25,
  4: 23,
...
export const salTable = Object.freeze({
  0: 0,
  1: 5,
  2: 7,
  3: 9,
...
export const getHpi = (combinedMove) => {
  if (combinedMove === 0) {
    return 0;
  }
...
export const getRangeIndex = (range) => {
  if (range <= 10) {
    return 0;
  }
...
export const getMovementMod = (shooterMove, targetMove, range) => {
